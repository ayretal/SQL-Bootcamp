CREATE TABLE person_audit (
  ...
  type_event char(1) CONSTRAINT ch_type_event CHECK (
    type_event IN ('I', 'U', 'D')
  ), 
...
CREATE 
OR REPLACE FUNCTION fnc_trg_person_insert_audit() RETURNS TRIGGER AS $trg_person_insert_audit$ BEGIN IF (TG_OP = 'INSERT') THEN INSERT INTO person_audit 
SELECT 
